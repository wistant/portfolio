export const registryConfig = {
   ...
   * @example "@wistant" - Users can install components with: `npx shadcn add @wistant/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@wistant",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://wistant.me/r/{name}.json" resolves to "https://wistant.me/r/wheel-picker.json"
